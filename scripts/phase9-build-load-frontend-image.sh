...
BUILDER_CPU_REQUEST="${PHASE9_BUILDER_CPU_REQUEST:-100m}"
BUILDER_MEMORY_REQUEST="${PHASE9_BUILDER_MEMORY_REQUEST:-256Mi}"
BUILDER_CPU_LIMIT="${PHASE9_BUILDER_CPU_LIMIT:-1}"
BUILDER_MEMORY_LIMIT="${PHASE9_BUILDER_MEMORY_LIMIT:-3Gi}"
